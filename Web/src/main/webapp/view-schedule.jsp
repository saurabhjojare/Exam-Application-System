            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="value" style = "padding-right: 15px">C++</td>
                    </tr>
                    <tr>
                        <td class="key" style = "padding-left: 15px">Date</td>
                        <td class="value" style = "padding-right: 15px">2024-03-28</td>
                    </tr>
                    <tr>
                        <td class="key" style = "padding-left: 15px">Start Time</td>
                        <td class="value" style = "padding-right: 15px">08:00:00</td>
                    </tr>
                    <tr>
                        <td class="key" style = "padding-left: 15px">End Time</td>
                        <td class="value" style = "padding-right: 15px">09:00:00</td>
                    </tr>
